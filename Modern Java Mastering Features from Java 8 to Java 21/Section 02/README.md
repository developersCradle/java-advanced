...
<img src="evolutionOftheModernJava.PNG"  alt="Java Advanced Course." width="500"/>

1. The module functionality was introduced in **Java 9**. The **one** legacy package was changed to more granary packages.

<img src="weWillCover.PNG"  alt="Java Advanced Course." width="500"/>

<img src="javaReleaseModel.PNG"  alt="Java Advanced Course." width="500"/>
