...
<div align="center">
    <img src="Map_Interface.JPG"  alt="Java Collections from basics to Advanced Course!" width="500"/>
</div>

1. **Map Interface** introduction!
    - This is represented object in **key-value** pair!

<div align="center">
    <img src="Introduction_Map_Interface.JPG"  alt="Java Collections from basics to Advanced Course!" width="500"/>
</div>

1. There is **key** and **values**!
2. Map properties:
    - **Keys** and **values** are objects, can be of any **data type**.
    - **Duplicates** in **Map**:
        - ❌**keys**❌ are **not allowed** *duplicate*.
        - ✔️**values**✔️ are **allowed** to have *duplicate*.
    - `2.1` Collection of entry objects, meaning each `key-value` is called `entry`.

- We can explore the `Map` **interface** [docs](https://docs.oracle.com/javase/8/docs/api/java/util/Map.html)!
    - We just explore everything here.
    - Todo these one, if needed!
    
# Hashing.

- We will be going hashing.
    - How its implemented.
    - Why its important!

> [!IMPORTANT]
> When **overridden**, both `hashcode()` and the `equal()` should be implemented in same time!

<div align="center">
    <img src="Hashing.JPG"  alt="Java Collections from basics to Advanced Course!" width="500"/>
</div>

1. **Hashing** is a function that, when we will provide it with **object**, this will gives the address of an **hash** for that table
    - **Hash** is combination of **letters** and **numbers**!
2. **Hash Function** is a `hashCode()` in a Java **Object class**!
3. There is two example of `hashCode()` → `12` and `56`!
...
<div align="center">
    <img src="Introduction_Map_HashMap.JPG"  alt="Java Collections from basics to Advanced Course!" width="500"/>
</div>
...
2. Characteristics of the `HashMap`:
    - `2.1` Insertion order is not preserved.
        - Since, its based **hash code**.
    - `2.2` Duplicate **keys** are **not** allowed.
        - **Values** can be duplicated!
    - `2.3` Allows **one** `null` **key** only.
        - **Values** can be `null` **more than once**.
    - `2.4` Heterogeneous elements are allowed as key and value both.
        - Meaning this can accept **many types** of **objects**! 
    - `2.5` Implements **Serializable** and **Cloneable** interface.
    - `2.6` Extends the abstract class `AbstractMap`.
    - `2.7` Best choice for **search operations**.
        - Since this is using the **hashing**!

<div align="center">
    <img src="HashMap_Hashing.JPG"  alt="Java Collections from basics to Advanced Course!" width="500"/>
</div>

1. **Hashing** is used to store data!
2. **Hashing** is the technique, converting **Large String** in with the **Small String** that represents **same** data!
    -  This will be applied to the **keys**!
3. **HashMap** has array of the `Nodes`!
    - **Notice**, the nodes are like **Linked List**!
4. **Node** contains fields:
    - **Hash**.
    - **Key**.
    - **Value**.
    - **Next**.
...
<details>
<summary id="hashmap_class_from_jdk" open="true"> <b>HashSet class from JDK</b>! </summary>
...
<div align="center">
    <img src="HashMap_Hierarchy_As_Reminder.JPG"  alt="Java Collections from basics to Advanced Course!" width="500"/>
</div>
